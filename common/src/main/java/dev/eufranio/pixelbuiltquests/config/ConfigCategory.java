...
public class ConfigCategory {
    ...
    @Setting
    @Comment("the default chat type used when sending task notify messages, can be either action_bar or chat. " +
            "can be overriden on tasks.")
    public ChatType taskNotifyChatType = ChatType.ACTION_BAR;
    ...
    public static class Messages {
        ...
        @Setting
        @Comment("supports %display%, %task%, %current%, %total% and %percentage%")
    ...
    public static class DatabaseCategory {
        ...
        @Setting
        public String url = "jdbc:h2:./PixelBuiltQuests.db;mode=MySQL";
